 ...
 * also when suspended).
 */
#define DEFAULT_SLEEP_IDEAL_FREQ (35800)
 ...
 */
#define DEFAULT_RAMP_UP_STEP (2572800)
 ...
 */
#define DEFAULT_SLEEP_WAKEUP_FREQ (2572800)
...
enum {
	SMARTASS_DEBUG_JUMPS=0,
	SMARTASS_DEBUG_LOAD=0,
	SMARTASS_DEBUG_ALG=0
};
