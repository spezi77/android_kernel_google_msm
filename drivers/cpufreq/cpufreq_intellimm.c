...
static inline cputime64_t get_cpu_idle_time2(unsigned int cpu, cputime64_t *wall)
{
...
static void dbs_check_cpu(struct cpu_dbs_info_s *this_dbs_info)
{
	...
	for_each_cpu(j, policy->cpus) {
		...
		cur_idle_time = get_cpu_idle_time2(j, &cur_wall_time);
...
static int cpufreq_gov_dbs_up_task(void *data)
{
	...
	while (1) {
		...
		this_dbs_info->prev_cpu_idle = get_cpu_idle_time2(cpu,
